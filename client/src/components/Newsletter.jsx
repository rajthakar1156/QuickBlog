  ...
  return (
    <div className=' flex flex-col items-center justify-center text-center space-y-2 my-32'>
        ...
        <form className=' flex items-center justify-between max-w-2xl w-full md:h-14 h-12' >
            ...
            <button className='md:px-12 px-8 h-full text-white bg-blue-800/80 hover:bg-blue-800 transition-all cursor-pointer rounded-md' type='submit'>Subscribe</button>
        </form>
    </div>
  )
}
